...
def get_time_delta():
    ...
    stream_start_time = datetime.strptime("07/02/24 09:00", "%d/%m/%y %H:%M")
    ...
    time_left_minutes = math.floor((time_left_seconds / 60) % 60)

    time_left_hours = math.floor(time_left_seconds / 3600)
...
def gen_title():
    ...
    if hrs == 0:
        TITLE_STRING = f"Live in {mins} minutes. Unless I'm late..."
    elif mins == 0:
